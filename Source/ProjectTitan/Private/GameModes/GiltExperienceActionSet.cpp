...
#define LOCTEXT_NAMESPACE "GiltSystem"

UGiltExperienceActionSet::UGiltExperienceActionSet()
{
}

#if WITH_EDITOR
EDataValidationResult UGiltExperienceActionSet::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UGiltExperienceActionSet::UpdateAssetBundleData()
{
