...
UGiltExperienceDefinition::UGiltExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGiltExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UGiltExperienceDefinition::UpdateAssetBundleData()
{
