...
#include "GiltPlatformEmulationSettings.h"
...
UGiltPlatformEmulationSettings::UGiltPlatformEmulationSettings()
{
}

FName UGiltPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UGiltPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UGiltPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UGiltPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UGiltPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UGiltPlatformEmulationSettings::PostInitProperties()
{
...
void UGiltPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UGiltPlatformEmulationSettings::ApplySettings()
{
...
void UGiltPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UGiltPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UGiltPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UGiltPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
