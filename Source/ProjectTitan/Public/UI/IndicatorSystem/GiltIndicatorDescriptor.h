...
#include "GiltIndicatorDescriptor.generated.h"
...
{
	bool Project(const UGiltIndicatorDescriptor& IndicatorDescriptor, const FSceneViewProjectionData& InProjectionData, const FVector2D& ScreenSize, FVector& ScreenPositionWithDepth);
};
 ...
 */
UCLASS()
class PROJECTTITAN_API UGiltIndicatorDescriptor : public UObject
{
	GENERATED_BODY()

public:
	UGiltIndicatorDescriptor() { }
