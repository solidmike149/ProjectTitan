...
#include "TiAsyncAction_CooldownChanged.generated.h"
...
class PROJECTTITAN_API UTiAsyncAction_CooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UTiAsyncAction_CooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags);
