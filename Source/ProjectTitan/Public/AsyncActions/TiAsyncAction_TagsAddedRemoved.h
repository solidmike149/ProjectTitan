...
#include "TiAsyncAction_TagsAddedRemoved.generated.h"
...
class PROJECTTITAN_API UTiAsyncAction_TagsAddedRemoved : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UTiAsyncAction_TagsAddedRemoved* ListenForGameplayTagAddedOrRemoved(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer Tags);
