...
#include "TiAsyncTaskTagsAddedRemoved.generated.h"
...
class PROJECTTITAN_API UTiAsyncTaskTagsAddedRemoved : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UTiAsyncTaskTagsAddedRemoved* ListenForGameplayTagAddedOrRemoved(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer Tags);
