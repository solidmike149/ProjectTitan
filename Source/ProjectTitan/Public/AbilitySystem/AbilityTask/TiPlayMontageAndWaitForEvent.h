...
#include "TiPlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class PROJECTTITAN_API UTiPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

	public:
	// Constructor and overrides
	UTiPlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UTiPlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UTiAbilitySystemComponent* GetTargetASC();
