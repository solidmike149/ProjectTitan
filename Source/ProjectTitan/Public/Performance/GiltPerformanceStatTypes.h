...
UENUM(BlueprintType)
enum class EGiltStatDisplayMode : uint8
{
...
UENUM(BlueprintType)
enum class EGiltDisplayablePerformanceStat : uint8
{
	// stat fps (in Hz)
	ClientFPS,
...
ENUM_RANGE_BY_COUNT(EGiltDisplayablePerformanceStat, EGiltDisplayablePerformanceStat::Count);
